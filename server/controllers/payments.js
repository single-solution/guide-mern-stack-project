					...
					await users.findOneAndUpdate(
						{ _id: session.client_reference_id, "subscriptions.subscription": session.productID },
						{
							$set: {
								...
								"subscriptions.$.cancellation.status": false,
								"subscriptions.$.cancellation.date": null,
								"subscriptions.$.cancellation.reason": null,
							},
						},
						{ new: true },
					);
						...
						{ _id: session.client_reference_id },
						{
							$push: {
								subscriptions: {
									...
									cancellation: { status: false, date: null, reason: null },
								},
							},
						},
				...
				const updatedUser = await users.findOneAndUpdate(
					{ _id: authenticatingDBUser._id },
					{
						$set: {
							...
							[`subscriptions.${subscriptionIndex}.cancellation`]: {
								status: true,
